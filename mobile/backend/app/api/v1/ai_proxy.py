...
def _to_http_error(e: Exception) -> HTTPException:
    ...
    if isinstance(e, AiUpstreamError):
...
def ocr(
    ...
    try:
        return OcrResponse(text=ocr_extract(client, body.content_base64, body.mime_type))
